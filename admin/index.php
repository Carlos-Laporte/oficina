        ...
        <div class="corpo_main">
            <div class="corpo_lateral">
                ...
                <div class="areaDeNavegacao">
                    <div class="telas">
                        <a href="../pages/dashboard.php"><i class="bi bi-house-door-fill"></i><span class="menuText"> Dashboard</span></a>
                        <a href="../pages/clientes.php"><i class="bi bi-person-fill"></i> Clientes</a>
