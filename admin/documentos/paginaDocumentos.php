<?php
    ...
    $colunaOs = $conn->query("SHOW COLUMNS FROM documentos LIKE 'os_id'")->fetch(PDO::FETCH_ASSOC);
    if (!$colunaOs) {
        $conn->exec("ALTER TABLE documentos ADD COLUMN os_id INT UNSIGNED NULL AFTER id");
    }
?>
...
<html lang="pt-br">
    <head>
        ...
        <title>Documentos — Lelicar Center Automotivo</title>
                ...
                <div class="corpo_lateral">
                    ...
                    <div class="areaDeNavegacao">
                        <div class="telas">
                            ...
                            <a href="/oficina/admin/documentos/paginaDocumentos.php" class="ativo"><i class="bi bi-file-earmark-arrow-up"></i> Documentos</a>
                        </div>
                        <div class="sair">
