...
<html lang="pt-br">
    <head>
        ...
        <title>Ordens de Serviço — Lelicar Center Automotivo</title>
            ...
            <div class="corpo_main">
                <div class="corpo_lateral">
                    ...
                    <div class="areaDeNavegacao">
                        <div class="telas">
                            ...
                            <a href="/oficina/admin/OS/paginaOrdemServico.php" class="ativo"><i class="bi bi-card-checklist"></i> Ordens de Serviço</a>
                ...
                <div class="corpoInformacao">
                    ...
                    <div class="parteInformacao">
                        <h2>Ordem de Serviço</h2>
                        <p>Dashboard > Ordem de Serviço</p>
                        <div class="conjunto">
